        ...
        <div className="bg-base-300 rounded-xl p-6 space-y-5">
          ...
          <div className="space-y-7">
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-base-200 rounded-lg border border-base-content/10">{currentUser?.fullname}</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <p className="px-4 py-2.5 bg-base-200 rounded-lg border border-base-content/10">{currentUser?.email}</p>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center text-success pl-2">{currentUser?.isEmailVerified ? "Verified" : <button className="btn btn-outline text-base" onClick={resendVerifyLink}>{isVerifying ? "Verifying..." : "Verify"}</button>} </div>
            </div>
          </div>
