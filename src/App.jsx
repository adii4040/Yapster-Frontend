...
import { Home, Settings, Login, Signup, Profile, ReqForgetPassword, ResetForgetPassword, Update, VerifyEmail, Landing } from './Pages/index'
      ...
      <div data-theme={theme} className="min-h-screen flex flex-col bg-base-100">
        <Routes>
          <Route path='/' element={<Layout />}>
            ...
            <Route path='/user/:resetPasswordToken/reset-forgot-password' element={<ResetForgetPassword />} />
